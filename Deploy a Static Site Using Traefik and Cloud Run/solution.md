...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/Traefik_and_Cloud_Run.sh

sudo chmod +x Traefik_and_Cloud_Run.sh

./Traefik_and_Cloud_Run.sh
```
