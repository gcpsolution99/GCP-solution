...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/GSP125_2025_Task1.sh

sudo chmod +x GSP125_2025_Task1.sh

./GSP125_2025_Task1.sh
```

### Note: Check my progress till task 3 once you got score then only run below command.

```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/GSP125_2025_Task2.sh

sudo chmod +x GSP125_2025_Task2.sh

./GSP125_2025_Task2.sh
```
