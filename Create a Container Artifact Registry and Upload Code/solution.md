...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/registry_container.sh

sudo chmod +x registry_container.sh

./registry_container.sh
```
