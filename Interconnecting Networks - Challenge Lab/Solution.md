...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/InterconnectingNetworks.sh

sudo chmod +x InterconnectingNetworks.sh

./InterconnectingNetworks.sh
```
