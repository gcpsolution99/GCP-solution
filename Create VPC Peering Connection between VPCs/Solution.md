...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/VPC_Peering_Connection.sh

sudo chmod +x VPC_Peering_Connection.sh

./VPC_Peering_Connection.sh
```
