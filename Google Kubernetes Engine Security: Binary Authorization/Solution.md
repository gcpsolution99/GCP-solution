...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/GSP479.sh
sudo chmod +x GSP479.sh
./GSP479.sh
```

### Binary Authorization policy: https://console.cloud.google.com/security/binary-authorization/policy?referrer=search&project=$DEVSHELL_PROJECT_ID
