...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/Maven_Artifact_Registry.sh

sudo chmod +x Maven_Artifact_Registry.sh

./Maven_Artifact_Registry.sh
```
