...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/ARC/ControllingAccess.sh

sudo chmod +x ControllingAccess.sh

./ControllingAccess.sh
```
