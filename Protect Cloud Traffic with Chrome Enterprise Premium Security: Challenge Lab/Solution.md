...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/GSP373.sh
sudo chmod +x GSP373.sh
./GSP373.sh
```

Configure OAuth consent screen: https://console.cloud.google.com/apis/credentials/consent?project=

Configure IAP: https://console.cloud.google.com/security/iap?tab=applications&project=
