...
read -p "ENTER YOUR REGION: ${RESET_FORMAT}" REGION
read -p "ENTER YOUR TOPIC NAME: ${RESET_FORMAT}" TOPIC
read -p "ENTER YOUR CLOUD FUNCTION NAME: ${RESET_FORMAT}" FUNCTION
