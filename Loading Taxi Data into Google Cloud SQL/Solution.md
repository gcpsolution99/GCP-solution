...
```
curl -LO https://raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/abhik.sh
sudo chmod +x abhik.sh
./abhik.sh
```

#### ---> Enter password: Passw0rd (after entering password you will not able to see. so just past and press enter)
