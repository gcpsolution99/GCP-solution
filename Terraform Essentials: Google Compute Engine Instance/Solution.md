...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/abhi_Terraform_Essentials.sh

sudo chmod +x abhi_Terraform_Essentials.sh

./abhi_Terraform_Essentials.sh
```
