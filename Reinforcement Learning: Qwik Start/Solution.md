...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/main/Reinforcement%20Learning%3A%20Qwik%20Start/GSP691.sh
sudo chmod +x GSP691.sh
./GSP691.sh
```
### Step 2: Open JupyterLab https://console.cloud.google.com/vertex-ai/workbench
