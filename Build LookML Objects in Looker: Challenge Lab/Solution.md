...
<img width="163" alt="image" src="https://github.com/user-attachments/assets/7dab46ce-3e94-4255-8fca-4e950424d410">


## Step 1: Create View (order_items_challenge) -> Paste below Content
...
## Step 2: Create View (user_details) -> Paste below Content
...
## Step 3: training_ecommerce -> Paste below Content -> Replace VALUE_1 and VALUE_2
...
```
# Note: Check score till task 3 then perform below task

## Step 4: training_ecommerce -> Paste below Content -> Replace no of hours
