...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/Abhi_Cloud_Firestore.sh

sudo chmod +x Abhi_Cloud_Firestore.sh

./Abhi_Cloud_Firestore.sh
```
