...
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/AuditLogs.sh

sudo chmod +x AuditLogs.sh

./AuditLogs.sh
```
## Open link: https://console.cloud.google.com/logs/query 
