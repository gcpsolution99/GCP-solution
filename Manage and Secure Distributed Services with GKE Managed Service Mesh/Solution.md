...
### Step 1: Run below command in cloud shell
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/GSP1242_Part1.sh

sudo chmod +x GSP1242_Part1.sh

./GSP1242_Part1.sh
```
### Step 2: Run below command in cloud shell
```
watch -g "gcloud container fleet mesh describe | grep 'code: REVISION_READY'"
```
### Step 3: Run below command in cloud shell
```
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/refs/heads/main/GSP/GSP1242_Part2.sh

sudo chmod +x GSP1242_Part2.sh
